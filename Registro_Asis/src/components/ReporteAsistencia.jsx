...
export default function ReporteAsistencia() {
  const todosLosDatos = [
    { empleado: 'Juan', mes: 'Enero', fecha: new Date(2024, 0, 5), asistencias: 1 },
    { empleado: 'Ana', mes: 'Enero', fecha: new Date(2024, 0, 6), asistencias: 1 },
    { empleado: 'Juan', mes: 'Febrero', fecha: new Date(2024, 1, 3), asistencias: 1 },
    { empleado: 'Carlos', mes: 'Febrero', fecha: new Date(2024, 1, 10), asistencias: 1 },
    { empleado: 'Ana', mes: 'Marzo', fecha: new Date(2024, 2, 2), asistencias: 1 },
  ];
  ...
  const exportarPDF = () => {
    ...
    const columnas = ['Empleado', 'Mes', 'Fecha', 'Asistencias'];
    const filas = datosFiltrados.map(d => [d.empleado, d.mes, d.fecha.toLocaleDateString(), d.asistencias]);
